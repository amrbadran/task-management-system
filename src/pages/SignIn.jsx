...
const SignIn = () => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 relative overflow-hidden ${darkMode ? "bg-dark-bg" : "bg-gray-50"
      ...
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-primary-purple/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }} />
      ...
      <div className={`relative w-full max-w-md ${darkMode ? "bg-dark-card/80" : "bg-white/80"
        ...
        <div className="text-center mb-8">
          <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4 ${darkMode ? "bg-primary-blue/20" : "bg-primary-blue/10"
            }`}>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center cursor-pointer group">
              <input
                ...
                className="sr-only"
              />
              <div className={`relative w-5 h-5 rounded ${staySignedIn
                ? "bg-primary-blue"
                : darkMode
              ...
              <span className={`ml-2 text-sm ${darkMode ? "text-text-light" : "text-gray-700"
                }`}>
                Stay signed in
              </span>
            </label>

            <Link to="/forgot-password" className={`text-sm font-medium ${darkMode ? "text-primary-blue hover:text-primary-light" : "text-primary-dark hover:text-primary-blue"
        ...
        <div className="mt-8 text-center">
          <p className={`text-sm ${darkMode ? "text-text-muted" : "text-gray-500"
            ...
            <Link
              to="/signup"
              className={`font-semibold ${darkMode ? "text-primary-blue hover:text-primary-light" : "text-primary-dark hover:text-primary-blue"
                } transition-colors duration-200`}
            >
              Sign up for free
            </Link>
