...
import { FaProjectDiagram, FaUsers, FaTasks, FaCheckCircle, FaClock } from "react-icons/fa";
      ...
      <div className="container mx-auto px-4 animate-fade-in">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className={`text-right ${darkMode ? "text-text-light" : "text-gray-700"}`}>
              <div className="flex items-center gap-2">
                <FaClock className={`w-4 h-4 ${darkMode ? "text-text-muted" : "text-gray-500"}`} />
          ...
          <div className={`${darkMode ? "bg-dark-card" : "bg-white"
            ...
            <div className="space-y-3">
              {projects.slice(0, 3).map((project) => (
                <div key={project.id} className={`flex items-center justify-between p-3 rounded-xl ${darkMode ? "bg-dark-elevated" : "bg-gray-50"
                  }`}>
                  <div>
          ...
          <div className={`${darkMode ? "bg-dark-card" : "bg-white"
            ...
            <div className="space-y-3">
              {tasks.slice(0, 3).map((task) => (
                <div key={task.id} className={`flex items-center justify-between p-3 rounded-xl ${darkMode ? "bg-dark-elevated" : "bg-gray-50"
                  }`}>
                  <div>
                    <p className={`font-medium ${darkMode ? "text-white" : "text-gray-900"}`}>
                      {task.name}
                  ...
                  <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${task.status === "Completed"
                    ? "bg-green-500/20 text-green-400"
