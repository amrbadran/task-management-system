...
import { FaTimes, FaCalendarAlt, FaUsers, FaTags, FaFlag, FaProjectDiagram } from "react-icons/fa";
            ...
            <div className="modal-content max-w-3xl animate-slide-up">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        <div className={`p-3 rounded-xl ${darkMode ? "bg-primary-blue/20" : "bg-primary-blue/10"
                            }`}>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-6">
                            { }
                            <div>
                                <label className={`block mb-2 text-sm font-medium ${darkMode ? "text-text-light" : "text-gray-700"
                                    }`}>
                                    Project Title
                                </label>
                                <input
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className={`max-h-[180px] overflow-y-auto p-3 rounded-xl border ${darkMode
                                    ...
                                    {students && students.length > 0 ? (
                                        <div className="space-y-2">
                                            {students.map((student) => (
                                                <div
                                                    ...
                                                    className={`p-2.5 rounded-lg cursor-pointer transition-all duration-200 border ${selectedStudents.includes(student.id)
                                                        ? darkMode
                                                ...
                                                >
                                                    <div className="flex items-center gap-2">
                                                        <div className={`w-8 h-8 rounded-md flex items-center justify-center text-xs font-semibold ${selectedStudents.includes(student.id)
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <p className={`text-sm font-medium truncate ${selectedStudents.includes(student.id)
                                                            ...
                                                            {student.universityId && (
                                                                <p className={`text-xs truncate ${darkMode ? "text-text-muted" : "text-gray-500"
                                                                    }`}>
                                                                    {student.universityId}
                                                                </p>
                                                            )}
                                        ...
                                        <p className={`text-center py-8 ${darkMode ? "text-text-muted" : "text-gray-500"
                                            }`}>
