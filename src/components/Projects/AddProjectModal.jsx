        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <div className={`max-h-[200px] overflow-y-auto p-4 rounded-xl border ${darkMode
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {students.map((student) => (
                      <div
                        ...
                        className={`p-3 rounded-xl cursor-pointer transition-all duration-200 border-2 ${selectedStudents.includes(student.id)
                          ? darkMode
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center text-sm font-semibold ${selectedStudents.includes(student.id)
                          ...
                          <div className="flex-1">
                            <p className={`font-medium ${selectedStudents.includes(student.id)
              ...
              {selectedStudents.length > 0 && (
                <p className={`mt-2 text-sm ${darkMode ? "text-text-muted" : "text-gray-500"
                  }`}>
