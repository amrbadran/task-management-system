...
const Header = () => {
  ...
  return (
    <header
      className={`sticky top-0 z-30 px-6 py-4 ${darkMode ? "bg-dark-card/80" : "bg-white/80"
        } backdrop-blur-xl border-b ${darkMode ? "border-darkBorder/50" : "border-gray-200"
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          {currentUser && (
            <div className="flex items-center gap-3">
              <div className={`p-2.5 rounded-xl ${darkMode ? "bg-dark-elevated" : "bg-gray-100"
                }`}>
                <FaUserCircle className={`w-6 h-6 ${darkMode ? "text-primary-blue" : "text-primary-dark"
                  }`} />
              </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-medium transition-all duration-300 ${darkMode
